...
const BASE_URL = import.meta.env.VITE_NEWS_API_BASE_URL || 'https://api.thenewsapi.com/v1';
...
const mapTheNewsApiArticleToAppArticle = (apiArticle: any): Article => {
  ...
  return {
    ...
    category: mapCategory(apiArticle.categories?.[0] || '', apiArticle.source || ''),
...
export const getFullArticleContent = async (articleId: string): Promise<string> => {
  try {
  ...
  return [
    {
      ...
      description: 'Stay updated with the latest news from India and around the world. To see real news, add your News API key to the .env file: VITE_NEWS_API_KEY=your_key_here',
    ...
    },
    {
      ...
      description: 'Visit TheNewsAPI.com to get a free API key and enable real-time news from around the world. It only takes 2 minutes to sign up!',
      url: 'https://www.thenewsapi.com/',
      urlToImage: 'https://images.unsplash.com/photo-1495020689067-958852a7765e?w=800&h=400&fit=crop',
      publishedAt: new Date().toISOString(),
      source: { id: 'wenews', name: 'WeNews' },
      author: 'WeNews Team',
      category: 'General',
    },
    {
      ...
      description: 'Latest updates in technology, innovation, and digital transformation. Real news will appear here once API key is configured.',
      url: '#',
      urlToImage: 'https://images.unsplash.com/photo-1519389950473-47ba0277781c?w=800&h=400&fit=crop',
      publishedAt: new Date().toISOString(),
      source: { id: 'wenews', name: 'WeNews' },
      author: 'Tech Desk',
      category: 'Technology',
    },
    {
      ...
      description: 'Latest business news, market updates, and economic indicators. Add your API key to see real business news from trusted sources.',
      url: '#',
    ...
    },
    {
      ...
      description: 'Get the latest sports news, scores, and highlights. Configure your News API key to see real-time sports updates.',
      url: '#',
    ...
    },
    {
      ...
      description: 'Latest entertainment news, movie releases, and celebrity updates. Real entertainment news coming soon with API integration.',
      url: '#',
      urlToImage: 'https://images.unsplash.com/photo-1489599849927-2ee91cede3ba?w=800&h=400&fit=crop',
      publishedAt: new Date().toISOString(),
      source: { id: 'wenews', name: 'WeNews' },
