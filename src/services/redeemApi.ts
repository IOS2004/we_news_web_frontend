...
export const redeemApi = {
  ...
  getProductById: async (productId: string) => {
    return apiCall<Product>(apiClient.get(`/redeem/products/${productId}`));
  },

  // Get featured products
  getFeaturedProducts: async () => {
    return apiCall<Product[]>(apiClient.get("/redeem/products/featured"));
  },

  // Get cart
  getCart: async () => {
    return apiCall<CartItem[]>(apiClient.get("/redeem/cart"));
  },
  ...
  // Clear cart
  clearCart: async () => {
    return apiCall<{ success: boolean }>(apiClient.delete("/redeem/cart"), {
      showSuccess: true,
  ...
  createOrder: async (data: {
    ...
    return apiCall<Order>(apiClient.post("/redeem/orders", data), {
      showLoading: true,
      showSuccess: true,
  ...
  getOrderById: async (orderId: string) => {
    return apiCall<Order>(apiClient.get(`/redeem/orders/${orderId}`));
  },
  ...
  getStats: async () => {
    return apiCall<RedeemStats>(apiClient.get("/redeem/stats"));
  },
